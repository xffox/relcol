...
set guifont=Bitstream\ Vera\ Sans\ Mono\ 8,Fixed\ 10
...
silent only
cd ~/dvp/python/relcol
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 controller.py
badd +1 source.py
badd +1 musicbrainz_source.py
badd +1 settings.py
badd +134 storage.py
badd +1 at_client.py
badd +1 relcolapp.py
badd +1 relcol.py
badd +1 model.py
badd +144 ~/dvp/python/musput/musput
badd +3 ~/.relcol/conf.txt
badd +1 collector.py
badd +1 relcol
silent! argdel *
edit controller.py
...
silent! normal! zE
let s:l = 54 - ((39 * winheight(0) + 27) / 55)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((52 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
normal! 0
tabedit collector.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
